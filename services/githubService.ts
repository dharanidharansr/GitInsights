import { GitInsightsData, Language, Repository, ContributionBreakdown, CommunityStats } from "../types";
...
export const fetchUserStory = async (username: string, token?: string): Promise<GitInsightsData> => {
